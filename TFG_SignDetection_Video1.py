...
video_entrada = (r"C:\Users\ignac\Downloads\WhatsApp-Video-2023-01-19-at-13.00.29-_1_.avi")
...
while cap.isOpened(): 
	...
	noturnright_sign_scaled = noturnright_sign.detectMultiScale(gray, 1.1, minNeighbors=5 )
	...
	yield_sign_scaled = yield_sign.detectMultiScale(gray, 1.1, 2)
	parking_sign_scaled = parking_sign.detectMultiScale(gray, 1.1, 6)
