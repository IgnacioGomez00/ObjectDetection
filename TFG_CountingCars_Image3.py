...
#Lectura de imagen .png y selección de archivos Haar
img=cv2.imread(r"C:\Users\ignac\OneDrive\Escritorio\Python\TFG\images\CountingCars_Image3.png")
cars = cv2.CascadeClassifier(r"C:\Users\ignac\OneDrive\Escritorio\Python\TFG\XMLs\cars.xml")
...
cars_scaled = cars.detectMultiScale(gray, 1.2 , 2)
...
if len(cars_scaled) == 0:
	...
	cv2.putText(img, (" Number of cars detected: " + str(cars_scaled.shape[0])), (0,img.shape[0] -10), cv2.FONT_HERSHEY_TRIPLEX, 0.5,  (0,0,0), 1)
